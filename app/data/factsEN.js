...
const data = [
  {
    ...
    facts: [
      ...
      'Movimiento 19 de Abril-Masaya affirms that the withdrawal will bring a bloodbath since the people who have fought will not surrender easily.',
  ...
  },
  {
    date: '2018-06-30',
    facts: [
      'The IACHR, the Verification and Security Commission and the representative of the Episcopal Conference met with the self-convened of the April 10 Movement in Jinotepe to mediate the situation of the more than 200 vagrant vans, however no agreement was reached.',
  ...
  },
  {
    date: '2018-06-29',
    facts: [
      'Paulo Abrao, executive secretary of the IACHR, and Antonia Urrejola announce their return to Nicaragua on Sunday, June 1, to install the GIEI, which will begin its work on June 2nd.',
      'The United Nations investigative team will also enter the country and will be present for three months.',
      'The IACHR presented a report in Geneva during an event about the human rights crisis in Nicaragua.',
  ...
  },
  {
    ...
    facts: [
      ...
      'Authorities deny entry to El Chipote due to administrative problems with the delegation of the IACHR, which intended to inspect the conditions of the detainees.',
      'The IACHR team remained outside the Judicial Assistance Directorate for two hours while they waited for a response. The time was taken to collect the testimonies of the mothers and relatives of the detainees.',
  ...
  },
  {
    date: '2018-06-26',
    facts: [
      'The Nicaraguan Association for Human Rights (ANPDH) records 285 deaths, more than 1500 injured and around 156 missing due to the repression unleashed against the population since April 18.',
  ...
  },
  {
    ...
    facts: [
      ...
      'The IACHR announces that they have already installed the work plan of the Special Follow-up Mechanism for Nicaragua, which aims to follow up on the recommendations given during the first visit of the IACHR.',
      'The technical team of the Meseni is composed of Alvaro Botero and Fiorella Melzi, both part of the executive secretariat of the IACHR, and will remain in the country for as long as necessary.',
      ...
      'The Episcopal Conference bishops met in the morning with the technical mission of the IACHR to address the steps for their integration into the work of the national dialogue.',
  ...
  },
  {
    date: '2018-06-24',
    facts: [
      'Technical team of the IACHR in charge of installing the Special Follow-up Mechanism for Nicaragua (Meseni) arrives in the country.',
  ...
  },
  {
    ...
    facts: [
      ...
      'Episcopal Conference also reaffirmed its support for the final report of the IACHR and thanked the member countries of the OAS for treating the issue of the crisis in Nicaragua in the special session.',
  ...
  },
  {
    ...
    facts: [
      ...
      'Delegation of the church, together with Alvaro Leiva, director of the ANPDH, went to the police station to meet with the commissioner Avellan to call for an end to the violence.',
  ...
  },
  {
    ...
    facts: [
      ...
      'Offices of the High Commissioner, the IACHR and the European Union confirm that they have received an invitation from the government to send missions to Nicaragua to observe and assist in the investigations of crimes committed since April.',
      ...
      'Secretary Abrao also acknowledged the lack of funds to finance both delegations, so he called on international donors to support the IACHR.',
    ],
  },
  {
    date: '2018-06-19',
  ...
  },
  {
    ...
    facts: [
      ...
      'The ANPDH also announced that the people who were captured on June 14th in clashes in Nindiri have already been released.',
